...
class BSDateCalculatorUnitTest {
	def converter

	@Before
	public void onSetUp() {
		converter  = new DateCalculator()
	}

	@Test
	public void testConvertUsingCumulativeApproach() {
		converter = new DateCalculator(new AdToBSCumulativeStrategy())
	...
	@Test
	public void testConvertBikramUsingYearIndex() {
		converter = new DateCalculator(new AdToBSIndexedStrategy())
		assert '2069-5-31' == converter.convertToBikram(new LocalDate(2012, 9, 16))
		assert '2069-1-1' == converter.convertToBikram(new LocalDate(2012, 4, 13))
		assert '2068-12-30' == converter.convertToBikram(new LocalDate(2012, 4, 12))

		assert '2069-12-31' == converter.convertToBikram(new LocalDate(2013, 4, 13))
		assert '2070-1-1' == converter.convertToBikram(new LocalDate(2013, 4, 14))
		assert '2058-10-4' == converter.convertToBikram(new LocalDate(2002, 1, 17))
	}

	@Test
	public void testConvertFromBikramToAd() {
